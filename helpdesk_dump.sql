...
INSERT INTO `grupa_korisnika` VALUES (1,'Korisnik',0,NULL,'default.png',NULL,1),(2,'Administrator',1,NULL,'default.png',NULL,1),(3,'Programska podrška',1,'programska.podrska@ciak.hr','default.png',NULL,1),(4,'Sistemska podrška',1,'sistemska.podrska@ciak.hr','default.png',NULL,1),(5,'Odjel za podatke',1,'webshop@ciak.hr','default.png','Web, matični podaci',1);
...
INSERT INTO `korisnik` VALUES (1,'Antonio','Kulić','antonio.kulic@ciak.hr','akulic','gAAAAABhub-f5bamw2gpC5hNzr0vUF6d7MrfmqjqpuRicPqKu8jo7AiAHxGEDR6QTYeqyW3X2H5POa1KTQFi4S8fTOAt7LQ2vA==',2,'2022-03-07 11:54:07',NULL,NULL,0,0,NULL,1,'2022-03-09 10:16:15');
...
INSERT INTO `ticket_vrsta` VALUES (1,3,'Prijava greške',NULL,1),(2,3,'Dorada Diglas',NULL,1),(3,3,'Dodjela prava',NULL,1),(4,4,'Prijava greške',NULL,1),(5,4,'Nabava opreme',NULL,1),(6,4,'Otvaranje mail / grupe',NULL,1),(7,5,'Partneri','Kupac/Dobavljač/Web korisnik',1),(8,5,'WMS',NULL,1),(9,5,'Produkti',NULL,1);
...
-- Dump completed on 2022-03-09 11:27:17
